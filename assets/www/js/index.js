...
var app = {
    ...
    onDeviceReady: function() {
        ...
        //var remoteFile = 'https://www.dropbox.com/s/awkng510ttro9ky/open-streets-dc.mbtiles';
        //self.downloadMbTiles(localFileName, remoteFile, self.buildMap);
        self.buildMap(localFileName)
    },

    onDocumentLoad : function() {
        var map = L.mapbox.map('map')
        //.setView([40.6681, -111.9364], 11);
        .setView([38.9013, -77.036], 12);
    ...
    buildMap : function(localFileName) {
        ...
        var layer = new L.TileLayer.MBTiles({minZoom: 7, maxZoom: 18, tms: true}, db);
